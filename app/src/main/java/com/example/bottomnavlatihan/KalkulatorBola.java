...
public class KalkulatorBola extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.calculateButton) {
            ...
            Intent intent = new Intent(KalkulatorBola.this, MainActivity.class);
    ...
    private double calculate(int num) {
        return (4.0/3.0) * Math.PI * num * num * num;
    }
}