...
public class KalkulatorJajargenjang extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalkulator_jajargenjang);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.calculateButton) {
            ...
            Intent intent = new Intent(KalkulatorJajargenjang.this, MainActivity.class);
