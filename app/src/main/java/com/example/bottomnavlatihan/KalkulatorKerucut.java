...
public class KalkulatorKerucut extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.calculateButton) {
            ...
            Intent intent = new Intent(KalkulatorKerucut.this, MainActivity.class);
    ...
    private double calculate(int num1, int num2) {
        return (1.0/3.0) * Math.PI * num1 * num1 * num2;
    }
}