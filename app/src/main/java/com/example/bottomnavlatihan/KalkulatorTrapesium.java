...
public class KalkulatorTrapesium extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.calculateButton) {
            ...
            info1.setText("sisi a = " + num1 +"cm");
            info2.setText("sisi b = " + num2 +"cm");
            info3.setText("t = " + num3 +"cm");
            result.setText("L = " + calculate(num1, num2, num3)+ "cm^2");
        } else if (view.getId() == R.id.backButton) {
            Intent intent = new Intent(KalkulatorTrapesium.this, MainActivity.class);
            startActivity(intent);
        }
    }

    private double calculate(int num1, int num2, int num3) {
        return 0.5 * num3 * (num1 + num2);
    }
}