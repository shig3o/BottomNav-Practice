...
public class KalkulatorSegitiga extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.calculateButton) {
            ...
            Intent intent = new Intent(KalkulatorSegitiga.this, MainActivity.class);
